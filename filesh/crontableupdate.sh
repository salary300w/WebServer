...
# 定义新任务（可多条）
TASKS=(
"35,40,45,50,55 09 * * 1-5 bash /root/workspace/planb.sh z"
"*/5 10,11,13 * * 1-5 bash /root/workspace/planb.sh z"
"0,5,10,15,20,25,30,35,40,45,50 14 * * 1-5 bash /root/workspace/planb.sh z"
